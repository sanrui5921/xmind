...
public class Solution_1019Test {
    ...
    public void nextLargerNodesTest1() {
        ...
        Assert.assertEquals("[5,5,0]", solution.nextLargerNodes(node));
    }
    ...
    public void nextLargerNodesTest2() {
        int[] array = {2, 7, 4, 3, 5};
        ListNode node = ListNodeBuilder.build(array);
        Assert.assertEquals("[7,0,5,5,0]", solution.nextLargerNodes(node));
    }
    ...
    public void nextLargerNodesTest3() {
        ...
        ListNode node = ListNodeBuilder.build(array);
        Assert.assertEquals("[7,9,9,9,0,5,0,0]", solution.nextLargerNodes(node));
    }
