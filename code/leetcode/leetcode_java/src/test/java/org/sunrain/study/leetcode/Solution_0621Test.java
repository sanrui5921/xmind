 ...
 */
public class Solution_0621Test {

    Solution_0621 solution;

    @Before
    public void init() {
        solution = new Solution_0621();
    }
    ...
    public void test1() {
        ...
        int n = 2;
        Assert.assertEquals(8, solution.leastInterval(chars, n));
    }
